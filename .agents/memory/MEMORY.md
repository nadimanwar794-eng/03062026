...
- [Unified content system](unified-content.md) — MULTI_TAB type in LessonView + virtual boards (LUCENT/COMPBOOK/GK/HOMEWORK) in AdminDashboard; admin saves Notes+MCQ+Video+Audio+PDF in one chapter.
