...
type ColorSection = 'BACKGROUND' | 'TOPBAR' | 'NAVIGATION' | 'WALLPAPERS' | 'CARDS' | 'BUTTONS' | 'TEXT' | 'ACCENTS' | 'FLASHCARD' | 'CHAPTERS' | 'MCQ_TABS';
...
const SECTIONS: Array<{ id: ColorSection; label: string; icon: React.ReactNode; desc: string }> = [
    ...
    { id: 'NAVIGATION', label: 'Navigation', icon: <Navigation size={13} />,   desc: 'Bottom nav buttons alag alag colors' },
    { id: 'WALLPAPERS', label: 'Wallpapers', icon: <Globe size={13} />,        desc: 'Tab wallpapers set karo' },
