      ...
      sections: {
        ...
        levelSystem: {
          ...
          levels: [
            ...
            { level: "L8 · Master Learner 💎",     pts: "2,00,000",   discount: "13% OFF",     perks: "Progress Bonus MAX 45%, sparkle effects" },
            { level: "L9 · Elite 🌟",              pts: "5,00,000",   discount: "17% OFF",     perks: "Unlimited notes/TTS, gold username" },
            { level: "L10 · Champion 👑",           pts: "10,00,000",  discount: "20% OFF",     perks: "Crown badge, premium status" },
            { level: "L11 · Legend 🏆",             pts: "25,00,000",  discount: "20% OFF",     perks: "Legendary aura, animated effects" },
            { level: "L12 · Mythic 🔮",             pts: "50,00,000",  discount: "22% OFF",     perks: "Mythic status, full animation suite" },
            { level: "L13 · Supreme ⚜️",            pts: "1,00,00,000", discount: "25% OFF",    perks: "Supreme badge, max visual effects" },
            { level: "L14 · Eternal 🌠",            pts: "2,50,00,000", discount: "28% OFF",    perks: "Eternal status, top leaderboard aura" },
            { level: "L15 · Absolute Legend 💠",    pts: "5,00,00,000", discount: "30% OFF",    perks: "Absolute Legend — highest rank in the app" },
          ],
          earningRules: [
      ...
      sections: {
        ...
        levelSystem: {
          ...
          levels: [
            ...
            { level: "L8 · Master Learner 💎",     pts: "2,00,000",   discount: "13% OFF",           perks: "Progress Bonus MAX 45%, sparkle effects" },
            { level: "L9 · Elite 🌟",              pts: "5,00,000",   discount: "17% OFF",           perks: "Unlimited notes/TTS, सोने जैसा username" },
            { level: "L10 · Champion 👑",           pts: "10,00,000",  discount: "20% OFF",           perks: "Crown badge, premium status" },
            { level: "L11 · Legend 🏆",             pts: "25,00,000",  discount: "20% OFF",           perks: "Legendary aura, animated effects" },
            { level: "L12 · Mythic 🔮",             pts: "50,00,000",  discount: "22% OFF",           perks: "Mythic status, full animation" },
            { level: "L13 · Supreme ⚜️",            pts: "1,00,00,000", discount: "25% OFF",          perks: "Supreme badge, max visual effects" },
            { level: "L14 · Eternal 🌠",            pts: "2,50,00,000", discount: "28% OFF",          perks: "Eternal status, top leaderboard aura" },
            { level: "L15 · Absolute Legend 💠",    pts: "5,00,00,000", discount: "30% OFF",          perks: "Absolute Legend — app का सबसे बड़ा rank" },
          ],
          earningRules: [
