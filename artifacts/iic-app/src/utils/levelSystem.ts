...
export const LEVEL_INFO: LevelInfo[] = [
  ...
  { level: 2,  minScore: 1000,      label: 'Apprentice',  emoji: '🌿', color: '#6ee7b7', gradient: 'from-emerald-300 to-teal-400',                 glowColor: 'rgba(110,231,183,0.35)', discount: 0,  animationIntensity: 0 },
  { level: 3,  minScore: 2000,      label: 'Explorer',    emoji: '🔍', color: '#38bdf8', gradient: 'from-sky-400 to-cyan-500',                     glowColor: 'rgba(56,189,248,0.4)',   discount: 2,  animationIntensity: 1 },
  { level: 4,  minScore: 5000,      label: 'Scholar',     emoji: '✨', color: '#06b6d4', gradient: 'from-cyan-400 to-sky-500',                     glowColor: 'rgba(6,182,212,0.45)',   discount: 3,  animationIntensity: 1, nameColor: '#06b6d4' },
