...
export const TIER_THEME = {
  ...
  free: {
    ...
    navRing:       'rgba(30,58,138,0.18)',
    pillGrad:      'linear-gradient(90deg,#1e3a8a,#2563eb,#3b82f6)',
    topBarGrad:    'linear-gradient(135deg,#1a3058 0%,#243b6e 50%,#1a3058 100%)',
    btnGrad:       'linear-gradient(135deg,#1a3058,#1e3a8a)',
    shadowColor:   'rgba(30,58,138,0.28)',
    profileBg:     '#0d1d3a',
    profileCardBg: '#162848',
    navBg:         '#ffffff',
    navActive:     '#1e3a8a',
    navInactive:   '#94a3b8',
    cardBg:        '#ffffff',
